...
| [cosh-ng 扩展平台阶段 0–4 验收](2026-07-20-cosh-ng-extension-platform.md) | [triage](../triage/2026-07-17-cosh-ng-extension-platform.md)、[符合性审计](../progress/2026-07-20-cosh-ng-extension-platform-conformance-audit.md)、[ECS 结果](../progress/2026-07-20-cosh-ng-extension-platform-ecs-e2e-result.md) | 隔离 ECS E2E-01–08、最终 RPM 回装复验、证据扫描和 Cleanup Gate 全部通过。 |
| [cosh-ng 测试稳定性与分层门禁验收](2026-07-23-cosh-ng-test-stability-gates.md) | [triage](../triage/2026-07-22-cosh-ng-shell-e2e-stability.md)、[design](../design/2026-07-22-cosh-ng-shell-e2e-stage-acceptance.md)、[spec](../specs/2026-07-23-cosh-ng-test-regression-gates.md)、[ADR-009](../adr/ADR-009-cosh-ng-test-ownership-and-stage-gates.md) | fast/integration/heavy 分层门禁、本地全量回归、release build 与未执行真实环境边界。 |
